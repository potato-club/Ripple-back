...
public enum ErrorCode {
    ...
    // USER (1000–1099) — 리넘버링 완료(빈 번호 없음)
    ...
    // POST / MEDIA / BOOKMARK / FEED (1200–1299) — 리넘버링 완료
    ...
    INVALID_OBJECT_KEY(HttpStatus.BAD_REQUEST, "1204", "유효하지 않은 object key입니다."),
    ALREADY_BOOKMARKED(HttpStatus.CONFLICT, "1205", "이미 북마크된 상태입니다."),
    BOOKMARK_NOT_FOUND(HttpStatus.NOT_FOUND, "1206", "북마크가 존재하지 않습니다."), // 토글 API에선 보통 204로 마스킹
    ALREADY_LIKED_POST(HttpStatus.CONFLICT, "1207", "이미 좋아요를 누른 상태입니다."),
    POST_LIKE_NOT_FOUND(HttpStatus.NOT_FOUND, "1208", "좋아요가 존재하지 않습니다."), // 토글 API에선 보통 204로 마스킹
    INSUFFICIENT_CREDITS(HttpStatus.BAD_REQUEST, "1209", "잔여 보기 크레딧이 부족합니다."),
    CREDIT_BALANCE_INCONSISTENT(HttpStatus.INTERNAL_SERVER_ERROR, "1210", "피드 크레딧 처리 중 오류가 발생했습니다. 잠시 후 다시 시도해 주세요."),
    ...
    COMMENT_LIKE_NOT_FOUND(HttpStatus.NOT_FOUND, "1303", "좋아요가 존재하지 않습니다."), // 토글 API에선 보통 204로 마스킹
